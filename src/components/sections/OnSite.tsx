...
const photos = [
  {
    ...
    caption:
      "Защищаем стеклопакеты и прилегающие поверхности перед покраской рам — чисто, аккуратно, без следов.",
    meta: "Процесс · подготовка",
  },
  {
    src: "/images/pdf/team-work-2.jpg",
    title: "Команда в работе",
    caption:
      "Шлифовка и полировка стеклопакетов прямо на объекте. Возвращаем заводской блеск без демонтажа.",
    meta: "Процесс · реставрация",
  },
];
